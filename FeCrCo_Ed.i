...
# (Example shown in: https://mooseframework.org/source/kernels/SplitCHWRes.html)
  [del_phi] # del squared phi calculation with magnetization saturation included
    type = NewCoefDiffusion
    variable = phi
    m = M_sat
  []
...
# Koyama 2004, Table 1: kappa_c = 1.0e-14 (J*m^2/mol)
  ...
  [Magnetization_Saturation]
    type = DerivativeParsedMaterial
    f_name = m
    material_property_names ='i_tau(c2,c3) c1(c2,c3)'
    constant_names = '    ev_J             d       T         R                   B'
    constant_expressions ='6.24150934e+18   1e-27   ${tempe}  8.31446261815324   9.27e-24'
    function = 'ev_J*d*(B*(2.22*c1 - 0.01*c2 + 1.35*c3 - 0.85*c1*c2 + (2.4127 + 0.2418*(c3-c1))*c1*c3)*i_tau)'
    args = 'c2 c3'
    outputs = exodus
    derivative_order = 2
  []
...
#  []
  ...
  [F_system] # Total free energy of the system
    ...
    f_name = F_sum
    sum_materials = 'mg_G RT_clnc E_G m_ext' #ElasticCr' Ed
    args = 'c2 c3'
    derivative_order = 2
  []
[]
